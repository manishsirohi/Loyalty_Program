...
CREATE TABLE `datacard` (
  ...
  `Datacard_No` varchar(45) NOT NULL,
  `DC_amount` varchar(45) DEFAULT NULL,
  `Date` timestamp(4) NULL DEFAULT NULL,
  PRIMARY KEY (`Datacard_No`),
  KEY `datacard_foreign` (`id_no`),
  CONSTRAINT `datacard_foreign` FOREIGN KEY (`id_no`) REFERENCES `user` (`id_no`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `datacard` VALUES ('111','5263147891','520','2018-03-20 06:36:13.0000');
