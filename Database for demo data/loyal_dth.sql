...
CREATE TABLE `dth` (
  ...
  `DTH_amount` varchar(45) DEFAULT NULL,
  `Date` timestamp(4) NULL DEFAULT NULL,
  PRIMARY KEY (`Customer_Id`),
  KEY `dth_foreign` (`id_no`),
  CONSTRAINT `dth_foreign` FOREIGN KEY (`id_no`) REFERENCES `user` (`id_no`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `dth` VALUES ('111','1152','20','2018-03-15 12:45:34.0000'),('11152556','15264','67','2018-03-16 17:17:17.0000');
...
-- Dump completed on 2018-03-20 22:50:32
